<template>
  <view class="carbon-emission-page">
    ...
    <view>
      <u--text size="16" color="#000000" text="我的碳排放"></u--text>
    </view>
    <view>
    </view>
    <view>
    ...
    <view>
      <u--text size="16" color="#000000" text="登记碳排放"></u--text>
    </view>
    <view>
    ...
    <u-tabbar :value="currentTabbar" :fixed="true" :placeholder="true" :safeAreaInsetBottom="true">
      ...
      <u-tabbar-item text="碳排放" name="carbonEmission" icon="photo"></u-tabbar-item>
